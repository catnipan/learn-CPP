...
int main() {
  ...
  typedef ratio_add<ratio<2,7>, ratio<2,6>>::type AddRes;
  cout << AddRes::num << "/" << AddRes::den << endl;

  cout << boolalpha << ratio_equal<ratio<5,3>,ratio<25,15>>::value << endl;

  cout << ratio_divide<FiveThirds, ratio<0>>::num << endl;
}